...
- e52fed3: New subpath: `llm-output-guard/agent`, for degeneration **across** turns.
  ...
  correctly — nothing is wrong with any _response_. What is wrong is the sequence,
  ...
  **One shape is measurably out of reach and ships as a gap.** An agent circling
  ...
  and a _healthy_ edit/test rhythm 0.375: a margin of 0.069 against this package's
